  ...
  return (
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <div className="p-5 bg-gray-800 shadow-lg">
        <div className="flex items-center">
          ...
          <button
            ...
            className="p-3 mr-4 bg-gray-600 rounded-xl text-white font-bold shadow-lg hover:bg-blue-800 transition-all"
          > 
            search
          </button>
          <button
      ...
      <div className="flex flex-1">
        {/* Sidebar Filters */}
        <aside className="w-full md:w-1/4 p-8 bg-gradient-to-r from-cyan-600 to-cyan-1000 rounded-xl shadow-xl space-y-8">
          ...
          <button
            onClick={applyFilters}
            className="w-full p-3 bg-cyan-600 rounded-xl text-white font-bold shadow-lg hover:bg-cyan-800 transition-all"
          >
            Apply Filters
          </button>
        </aside>
