...
export default function CoachList() {
  ...
  <div className="min-h-screen bg-gradient-to-r from-cyan-300 to-cyan-1000 text-white flex flex-col">
    ...
    <div className="flex flex-1 flex-col md:flex-row">
      <aside className="w-full md:w-1/4 p-8 bg-gradient-to-r from-cyan-600 to-cyan-1000 shadow-xl space-y-8 mb-8 md:mb-0">
        ...
        <button
          onClick={applyFilters}
          className="w-full md:w-40 p-3 from-cyan-600 to-cyan-1000 rounded-xl text-white font-bold shadow-lg hover:bg-cyan-800 transition-all"
        >
          Apply Filters
        </button>
      </aside>
